-- db_test/seed.sqlite.sql
-- Converted from SQL Server to SQLite
-- Harborstone Insurance Seed Data
...
-- 1. CUSTOMERS
-- ============================================================================
INSERT OR IGNORE INTO Customers (customer_code, full_name, national_id, date_of_birth, phone, email, address, city, country, status)
VALUES
...
-- 2. EMPLOYEES
-- ============================================================================
INSERT OR IGNORE INTO Employees (employee_code, full_name, role_name, username, email, phone, department, hire_date, is_active)
VALUES
...
-- 3. VESSELS
-- ============================================================================
INSERT OR IGNORE INTO Vessels (customer_id, vessel_name, registration_number, imo_number, vessel_type, manufacturer, model, year_built, gross_tonnage, insured_value, current_location)
VALUES
...
-- 4. COVERAGE TYPES
-- ============================================================================
INSERT OR IGNORE INTO CoverageTypes (coverage_name, description)
VALUES
...
-- ============================================================================
INSERT OR IGNORE INTO InsurancePolicies (customer_id, vessel_id, policy_number, policy_type, coverage_amount, deductible, premium, start_date, end_date, status)
VALUES
...
-- 6. POLICY COVERAGE
-- ============================================================================
INSERT OR IGNORE INTO PolicyCoverage (policy_id, coverage_id, coverage_limit)
VALUES
...
-- 7. CLAIMS
-- ============================================================================
INSERT OR IGNORE INTO Claims (policy_id, assigned_employee_id, claim_number, incident_date, claim_date, claim_amount, estimated_loss, damage_type, description, priority, risk_level, status)
VALUES
...
-- 8. FRAUD CHECKS
-- ============================================================================
INSERT OR IGNORE INTO FraudChecks (claim_id, fraud_score, ai_recommendation, checked_by, fraud_status)
VALUES
...
-- 9. AUDIT LOGS
-- ============================================================================
INSERT OR IGNORE INTO AuditLogs (employee_id, action, table_name, record_id, ip_address)
VALUES
...
-- 10. CLAIM WORKFLOW
-- ============================================================================
INSERT OR IGNORE INTO ClaimWorkflow (claim_id, employee_id, workflow_stage, action, comments)
VALUES
...
-- 11. PAYMENTS
-- ============================================================================
INSERT OR IGNORE INTO Payments (claim_id, approved_by, payment_amount, payment_method, payment_date, payment_status, transaction_reference)
VALUES
